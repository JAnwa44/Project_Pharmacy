...
?> -->
    ...
    <ul class="nav justify-content-center">
        ...
        <li class="nav-item">
            <a class="nav-link" style="font-size:30px;cursor:pointer" href="menu_employee.php">EMPLOYEE</a>
        </li>
    </ul>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="setting_employee.php">Employee</a>
    <a href="history_Employee.php">HIS_Employee</a>
    <a href="Add_User.php">Add</a>
    <!-- <a href="chang_admin.php">chang password Admin</a> -->
  </div>
</div>
